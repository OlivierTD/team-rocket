 ...
 * @author Batoul Yehia
 */
public class ItunesHorizontalAdapter extends ArrayAdapter<ItunesHorizontalAdapter.Podcast> {
    /**
     * Related Context
     */
     ...
     */
    public ItunesHorizontalAdapter(Context context, List<Podcast> objects) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null) {
            view = ((MainActivity) context).getLayoutInflater()
                    .inflate(R.layout.toplist_item, parent, false);
